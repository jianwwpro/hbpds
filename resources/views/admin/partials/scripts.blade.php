<!-- jQuery 2.1.3 -->
    ...
    <script src="/plugins/simditor-2.1.13/scripts/module.js" type="text/javascript" ></script>
    <script src="/plugins/simditor-2.1.13/scripts/hotkeys.js" type="text/javascript" ></script>
